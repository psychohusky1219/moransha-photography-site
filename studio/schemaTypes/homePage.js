...
export const homePage = defineType({
  ...
  fields: [
    ...
    imageField("foodImage", "Food service photo", "features"),
    altField("foodImageAlt", "Food service photo description", "features"),
    ...
    imageField("realEstateImage", "Real estate service photo", "features"),
    altField("realEstateImageAlt", "Real estate service photo description", "features"),
